      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-8 w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-5">
          ...
          <div className="col-span-2 text-center">
            <button
              type="submit"
              className="bg-gradient-to-br from-black via-zinc-900 to-neutral-800 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:scale-105 hover:shadow-md hover:shadow-neutral-500/40 transition-all duration-200 ease-in-out"
