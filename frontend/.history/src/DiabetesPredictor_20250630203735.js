...
const DiabetesPredictor = () => {
  ...
  <p className="text-sm text-gray-300 tracking-wide italic drop-shadow">
    Made with 🖤 by <span className="font-semibold text-white hover:text-slate-300 transition">Wahib</span>
  </p>
</div>
