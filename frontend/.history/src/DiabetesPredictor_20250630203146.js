  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white font-sans">
     ...
     <div>
      ...
      <p className="mt-10 text-center text-sm text-cyan-400 tracking-wide italic drop-shadow-sm">
  Made with 💙 by <span className="font-semibold text-white">Wahib</span>
</p>
