...
const DiabetesPredictor = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white font-sans">
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-8 w-full max-w-2xl" style={{ boxShadow: 'inset 2px 2px 20px 1.5px rgba(250, 250, 250, 0.18)' }}>
...
">
        ...
        {prediction !== null && (
          <div className={`mt-6 p-5 text-center rounded-xl font-semibold border-2 transition-all duration-300 ${prediction === 1
              ? 'bg-gradient-to-r from-red-900 to-red-700 border-red-500 text-red-200 shadow-red-800/40 shadow-lg'
              : 'bg-gradient-to-r from-green-900 to-emerald-700 border-green-500 text-green-200 shadow-emerald-800/40 shadow-lg'
            }`}>
            {prediction === 1 ? '🩺 You may be Diabetic' : '✅ You are Not Diabetic'}
          </div>
