...
">
        ...
        {prediction !== null && (
         <div
  className={`mt-7 px-6 py-3 text-center rounded-xl border-[1px] backdrop-blur-sm shadow-lg transition-all duration-300
    ${prediction === 1
      ? 'bg-red-500/10 border-red-500 text-red-200'
      : 'bg-green-500/10 border-green-200 text-green-300'}
  `}
>
  <span className="text-lg tracking-wide font-semibold">
    {prediction === 1 ? '🩺 You may be Diabetic' : '✅ You are Not Diabetic'}
        ...
        <div className="mt-8 border-t border-cyan-700/30 pt-4 text-center">
          <p className="text-sm text-orange-400 tracking-wide italic drop-shadow-sm">
